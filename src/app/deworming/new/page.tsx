...
type DewormingFormData = z.infer<typeof dewormingSchema>
  ...
  const onSubmit = async (data: DewormingFormData) => {
    ...
    try {
      ...
      const dewormingData = {
        ...
        next_date: data.nextDueDate || null,
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(value) => setValue('productType', value)}>
                        ...
                        <SelectContent>
                          <SelectItem value="interno">Desparasitante Interno</SelectItem>
                          <SelectItem value="externo">Desparasitante Externo</SelectItem>
                          <SelectItem value="combinado">Combinado (Interno + Externo)</SelectItem>
                          <SelectItem value="pulguicida">Pulguicida</SelectItem>
                          <SelectItem value="garrapaticida">Garrapaticida</SelectItem>
                        </SelectContent>
                      </Select>
                      {errors.productType && (
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        id="notes"
                        placeholder="Información adicional sobre la desparasitación..."
                        {...register('notes')}
                      />
                    </div>
